...
# Crear un gráfico de barras cartesiano con un color gris
grafico_bullying_cartesiano <- ggplot(datos_bullying, aes(x = Nivel, y = Porcentaje, fill = Nivel)) +
  geom_bar(stat = "identity", width = 0.5, color = "black", fill = "gray") +
...
ggsave("grafico_bullying_cartesiano_gris.jpg", grafico_bullying_cartesiano, width = 6, height = 6, dpi = 300)
